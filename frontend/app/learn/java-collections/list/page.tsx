...
function DetailedLesson({ 
  ...
  const isCodeLine = (line: string): boolean => {
    ...
    const javaTypePattern = /^(int|String|double|boolean|char|byte|short|long|float|List|ArrayList|LinkedList|Iterator|Collections|Arrays)\s+\w+/;
    ...
    if (line.includes("=") && (line.includes("int ") || line.includes("String ") || line.includes("double ") || 
        line.includes("boolean ") || line.includes("char ") || line.includes("List<") || line.includes("ArrayList<") || line.includes("LinkedList<"))) {
      return true;
    }
                ...
                {(() => {
                  ...
                  const flushCodeBlock = () => {
                    if (currentCodeBlock.length > 0) {
                      ...
                      const language = code.includes("public class") || code.includes("System.out") || code.includes("List<") || code.includes("ArrayList<") || code.includes("LinkedList<") ? "java" : "bash";
                      elements.push(
