...
function DetailedLesson({ 
  ...
  const isCodeLine = (line: string): boolean => {
    ...
    const javaTypePattern = /^(int|String|double|boolean|char|byte|short|long|float|Set|HashSet|LinkedHashSet|TreeSet|SortedSet|Iterator|Collections|Arrays|Objects|List|ArrayList)\s+\w+/;
                ...
                {(() => {
                  ...
                  const flushCodeBlock = () => {
                    if (currentCodeBlock.length > 0) {
                      ...
                      const language = code.includes("public class") || code.includes("System.out") || code.includes("Set<") || code.includes("HashSet<") || code.includes("LinkedHashSet<") || code.includes("TreeSet<") ? "java" : "bash";
                      elements.push(
